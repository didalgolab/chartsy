...
class QuickSortTest {
    ...
    public void testSortInt() {
        ...
        assertTrue(one.chartsy.smile.math.Math.equals(order1, QuickSort.sort(data1)));
        int[] data2 = {9, 8, 7, 6, 5, 4, 3, 2, 1, 0};
        int[] order2 = {9, 8, 7, 6, 5, 4, 3, 2, 1, 0};
        assertTrue(one.chartsy.smile.math.Math.equals(order2, QuickSort.sort(data2)));
        int[] data3 = {0, 1, 2, 3, 5, 4, 6, 7, 8, 9};
        int[] order3 = {0, 1, 2, 3, 5, 4, 6, 7, 8, 9};
        assertTrue(one.chartsy.smile.math.Math.equals(order3, QuickSort.sort(data3)));
        int[] data4 = {4, 1, 2, 3, 0, 5, 6, 7, 8, 9};
        int[] order4 = {4, 1, 2, 3, 0, 5, 6, 7, 8, 9};
        assertTrue(one.chartsy.smile.math.Math.equals(order4, QuickSort.sort(data4)));
    }
