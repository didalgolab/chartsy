...
import one.chartsy.smile.math.matrix.Matrix;
import one.chartsy.smile.math.matrix.DenseMatrix;
import one.chartsy.smile.math.matrix.QR;
import one.chartsy.smile.math.matrix.SVD;
import one.chartsy.smile.math.matrix.Cholesky;
import one.chartsy.smile.math.special.Beta;
