...
@StudyParameter(id = "insideNeutralVisibility", name = "Inside Neutral Visibility", scope = StudyParameterScope.VISUAL, type = StudyParameterType.BOOLEAN, defaultValue = "true", order = 140)
@StudyParameter(id = "insideHighVisibility", name = "Inside High Visibility", scope = StudyParameterScope.VISUAL, type = StudyParameterType.BOOLEAN, defaultValue = "true", order = 145)
...
@FillPlotSpec(id = "insideNeutral", label = "Inside Neutral", output = "value", from = 1.4, to = 1.6, upper = true, colorParameter = "insideNeutralColor", visibleParameter = "insideNeutralVisibility", order = 10)
@FillPlotSpec(id = "insideHigh", label = "Inside High", output = "value", from = 1.6, to = 1.6, upper = true, colorParameter = "insideHighColor", visibleParameter = "insideHighVisibility", order = 20)
