...
@FillPlotSpec(id = "insideNeutral", label = "Inside Neutral", output = "value", from = 1.4, to = 1.6, upper = true, colorParameter = "insideNeutralColor", order = 10)
@FillPlotSpec(id = "insideHigh", label = "Inside High", output = "value", from = 1.6, to = 1.6, upper = true, colorParameter = "insideHighColor", order = 20)
