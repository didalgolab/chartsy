 ...
 * Modifications:
 * <ul>
 *     <li>[MB] 2023-02-01: Repackaged from <a href="https://github.com/mysto/java-fpe">Java-FPE</a> for inclusion in Chartsy|One.</li>
 * </ul>
 *
...
public class FF3Cipher {
    ...
    public FF3Cipher(String key, String tweak, String alphabet) {
        ...
        // NOTE: With log2 we could further simplify this
        ...
        return switch (base) {
            ...
            case 26 ->
                // used by NIST test vectors
                    DIGITS + "abcdefghijklmnop";
            case 36 -> DIGITS + ASCII_UPPERCASE;
            case 62 -> DIGITS + ASCII_UPPERCASE + ASCII_LOWERCASE;
            default -> throw new RuntimeException("Unsupported radix");
        };
    }
