...
class SimpleCandleTest {
    final SimpleCandle bullish = SimpleCandle.of(0L, 1, 3, 0, 2, 100, 10);
    final SimpleCandle bearish = SimpleCandle.of(0L, 2, 3, 0, 1, 100, 10);
    final SimpleCandle neutral = SimpleCandle.of(0L, 3, 3, 0, 3, 100, 10);
