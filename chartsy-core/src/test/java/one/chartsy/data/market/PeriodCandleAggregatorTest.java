...
class PeriodCandleAggregatorTest {
    ...
    static final PeriodCandleAlignment BREAK_AT_MIDNIGHT_UTC = new PeriodCandleAlignment(ZoneOffset.UTC, LocalTime.MIDNIGHT);
    static final PeriodCandleAlignment BREAK_AT_MIDNIGHT_CET = new PeriodCandleAlignment(ZoneId.of("Europe/Paris"), LocalTime.MIDNIGHT);
    ...
    void gives_handle_to_incomplete_Candle_which_could_be_stateful() {
        ...
        var incompleteCandleHandle =
                ...
                agg.add(Candle.of(now, 2.0), emitted::add);
    ...
    void aggregates_and_emits_completed_Candles() {
        ...
        agg.add(newCandle(LocalDateTime.of(2021, 10, 11, 0, 0), 3.0), emitted::add);
        // next hour candle
        agg.add(newCandle(LocalDateTime.of(2021, 10, 11, 0, 1), 4.0), emitted::add);
    ...
    void breaks_daily_Candles_at_specified_daily_alignment_time_and_zone() {
        ...
        agg.add(newCandle(LocalDateTime.of(2021, 10, 11, 22, 0), 3.0), emitted::add);
        // candle after midnight CET
        agg.add(newCandle(LocalDateTime.of(2021, 10, 11, 22, 1), 4.0), emitted::add);
    ...
    void can_break_weekly_Candles_at_specified_day_of_week_here_assuming_SUNDAY() {
        var BREAK_BEFORE_SUNDAY_CET = new PeriodCandleAlignment(ZoneId.of("Europe/Paris"), LocalTime.MIDNIGHT, DayOfWeek.SUNDAY);
        ...
        agg.add(newCandle(LocalDateTime.of(2021, 10, 16, 22, 0), 3.0), emitted::add);
        // candle after Sunday
        agg.add(newCandle(LocalDateTime.of(2021, 10, 16, 22, 1), 4.0), emitted::add);
    ...
    void can_break_weekly_Candles_at_specified_day_of_week_here_assuming_MONDAY() {
        var BREAK_BEFORE_MONDAY_CET = new PeriodCandleAlignment(ZoneId.of("Europe/Paris"), LocalTime.MIDNIGHT, DayOfWeek.MONDAY);
        var agg = new PeriodCandleAggregator<>(new SimpleCandleBuilder(), WEEKLY, BREAK_BEFORE_MONDAY_CET);
        // candles before midnight CET
        agg.add(newCandle(LocalDateTime.of(2021, 10, 10, 22, 1), 1.0), emitted::add);
        agg.add(newCandle(LocalDateTime.of(2021, 10, 11,  0, 0), 2.0), emitted::add);
        agg.add(newCandle(LocalDateTime.of(2021, 10, 17, 22, 0), 3.0), emitted::add);
        // candle after midnight CET
        agg.add(newCandle(LocalDateTime.of(2021, 10, 17, 22, 1), 4.0), emitted::add);
    ...
    void supports_MONTHLY_Candles() {
        var BREAK_ON_EACH_NEW_MONTH_MIDNIGHT_UTC = new PeriodCandleAlignment(ZoneOffset.UTC, LocalTime.MIDNIGHT, DayOfMonth.of(1));
        ...
        agg.add(newCandle(LocalDateTime.of(2021, 11, 1, 0, 0), 3.0), emitted::add);
        // candle after midnight CET
        agg.add(newCandle(LocalDateTime.of(2021, 11, 1, 0, 0).plusNanos(MICROSECOND), 4.0), emitted::add);
