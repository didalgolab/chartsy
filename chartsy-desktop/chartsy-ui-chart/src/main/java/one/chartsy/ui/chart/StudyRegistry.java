...
public final class StudyRegistry {
    ...
    private static SequencedMap<String, StudyDescriptor> loadDescriptors() {
        var descriptors = new LinkedHashMap<String, StudyDescriptor>();
        for (StudyDescriptorProvider provider : loadDescriptorProviders()) {
    ...
    private Snapshot snapshot() {
        SequencedMap<String, StudyDescriptor> descriptorsById = loadDescriptors();
        return new Snapshot(
                descriptorsById,
